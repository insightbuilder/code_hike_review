...
export default function Page() {
  const { introducing, steps, outro } = parseRoot(Content, Schema)
  return (
    <main>
      <Link href="/">Back</Link>
      <h1 className="mt-8">{introducing.title}</h1>
      Following is the child of the intro heading above
